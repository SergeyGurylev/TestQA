...
3. Настроить выгрузку результатов о прохождении тестов в Allure отчет. В качестве отчет пришлите скрин Allure отчета

Контекст:
Дано Я открыл новый сеанс TestClient или подключил уже существующий

Сценарий: 1. тест на проверку расчета суммы документа Заказ (подсистема Продажи) при изменении количества и цены
...
Сценарий: 2. тест на проверку доступности поля Количество при добавлении Услуги в документ Заказ (подсистема Продажи)
* Открытие формы нового документа
	И Я закрываю все окна клиентского приложения
	И В командном интерфейсе я выбираю "Продажи" "Заказы"
	Когда открылось окно 'Заказы товаров'
